...
_MODE_INSTRUCTIONS: dict[str, str] = {
    "concise": (
        ...
        "Answer directly in one to three sentences. "
        "Brief internal reasoning is fine but keep response short."
    ),
    "auto": (
        "[THINKING MODE: AUTO] /think "
        "Show brief reasoning when it aids clarity. "
        "Get to the answer quickly after thinking."
    ),
    "full": (
        "[THINKING MODE: FULL] /think "
        "Think step-by-step. Show all reasoning before the final answer. "
        "Use structured sections, numbered steps, or code blocks. "
